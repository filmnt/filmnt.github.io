...
<div id="navbar-dialog" style="display:none;position:fixed;top:0;right:0;width:100%;max-width:380px;height:100vh;flex-direction:column;background-color:var(--background);z-index:20000;overflow:hidden;">
  <div style="flex:0 0 auto;overflow-y:auto;padding:10px;">
...
<iframe 
  ...
  style="flex:1 1 auto;width:100%;border:0;margin-top:6px;min-height:80vh;"
></iframe>
</div>

      <button onclick="closeNavbar()" style="display:none;position:fixed;top:10px;left:calc(100% - 460px);width:40px;height:40px;opacity:0.3;z-index:20001"><i class="fa-solid fa-xmark fa-xl"></i></button>
      <div id="schedule-dialog" style="display:none;position:fixed;top:0;right:0;width:100%;max-width:380px;height:100vh;background-color: var(--background);z-index:20000;overflow-y:hidden;opacity:1">
        <div style="padding:10px;background-color: var(--background);opacity:1;">
          <span><iframe src="https://filmnt.github.io/scheduler/" style="margin-top:-20px;top:0;left:0;width:100%;height:100%;position:absolute;border:0;" allowfullscreen></iframe></span>
        </div>
      </div>
      <button onclick="closeNavbar()" style="display:none;position:fixed;top:10px;left:calc(100% - 460px);width:40px;height:40px;opacity:0.3;z-index:20001"><i class="fa-solid fa-xmark fa-xl"></i></button>
      ...
      <button onclick="closeNavbar()" style="display:none;position:fixed;top:10px;left:calc(100% - 460px);width:40px;height:40px;opacity:0.3;z-index:20001"><i class="fa-solid fa-xmark fa-xl"></i></button>
      <div id="excal-dialog" style="display:none;position:fixed;top:0px;right:0;width:100%;max-width:380px;height:100vh;background-color: var(--background);z-index:20000;overflow-y:hidden;opacity:1">
        <div style="padding:10px;background-color: var(--background);opacity:1;">
          <span>
            <iframe src="https://excalidraw.com/" style="margin-top:-20px;top:0;left:0;width:100%;height:100%;position:absolute;border:0;" allowfullscreen></iframe>
          </span>
        </div>
      </div>
      <button onclick="closeNavbar()" style="display:none;position:fixed;top:10px;left:calc(100% - 460px);width:40px;height:40px;opacity:0.3;z-index:20001"><i class="fa-solid fa-xmark fa-xl"></i></button>
      <div id="graph-dialog" style="display:none;position:fixed;top:0px;right:0;width:100%;max-width:380px;height:100vh;background-color: var(--background);z-index:20000;overflow-y:hidden;opacity:1">
        <div style="padding:10px;background-color: var(--background);opacity:1;">
          <span>
            <iframe src="https://filmnt.github.io/simplegraph/" style="margin-top:-20px;top:0;left:0;width:100%;height:100%;position:absolute;border:0;" allowfullscreen></iframe>
          </span>
        </div>
      </div>
      <button onclick="closeNavbar()" style="display:none;position:fixed;top:10px;left:calc(100% - 460px);width:40px;height:40px;opacity:0.3;z-index:20001"><i class="fa-solid fa-xmark fa-xl"></i></button>
      <div id="preview-dialog" style="display:none;position:fixed;top:0px;right:0;width:100%;max-width:380px;height:100vh;background-color: var(--background);z-index:20000;overflow-y:hidden;opacity:1">
        <div style="padding:10px;background-color: var(--background);opacity:1;">
          <div id="previewdiv">
