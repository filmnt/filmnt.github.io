  ...
  const Comments: QuartzComponent = ({ displayClass, cfg }: QuartzComponentProps) => {
    return (
      <footer class={`${displayClass ?? "comments"}`}>
        ...
        <span><a href="https://github.com/filmnt/home/discussions" target="_blank" >Comments</a></span>
        <span><a href="https://discord.gg/sHJxUDqbAE" target="_blank" >Discord</a></span>
        <span><a href="https://github.com/filmnt/home" target="_blank" >GitHub</a></span>
        </div>
