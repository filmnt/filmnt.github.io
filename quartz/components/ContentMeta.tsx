...
<button data-title="Share" class="dropdown" style="background-color:transparent;margin-right:10px;float:right;margin-top:-2px">
  ...
  <div id="myDropdown" class="dropdown-content">
    <div class="dropdown-item" onclick="navigator.clipboard.writeText(window.location.href); return false;"><i class="fa-regular fa-copy fa-xl"></i> Copy Link</div>
    <div class="dropdown-item" onclick="generateQRCode()"><i class="fa-solid fa-qrcode fa-xl"></i> QR Code</div>
  </div>
</button>
            )
            segments.push(
